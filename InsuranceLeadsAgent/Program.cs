...
using InsuranceLeadsAgent.Configuration;
using InsuranceLeadsAgent.Services;
...
builder.Services.AddScoped<ConversaCore.Agentic.DomainAgentService, InsuranceLeadsAgent.Services.InsuranceLeadsAgent>();
builder.Services.AddScoped<InsuranceLeadsAgent.Services.InsuranceLeadsAgent>(sp =>
    (InsuranceLeadsAgent.Services.InsuranceLeadsAgent)sp.GetRequiredService<ConversaCore.Agentic.DomainAgentService>()
);
...
try
{
    ...
    Console.WriteLine("Topic configuration complete (InsuranceLeadsAgent)");
