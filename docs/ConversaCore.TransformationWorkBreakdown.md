...
- [ ] **CC-503 — Define typed insurance host contracts.** Immutable progress, customer-console, navigation, and qualification contracts are defined and consumed at `Home.OnHostOutput`; navigation production and E2E evidence remain before closure.
