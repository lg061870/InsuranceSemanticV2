...
- [ ] **CC-311 — Assemble and register the concrete `IConversationRuntime` facade.** Compose the completed runtime services, start-topic selection, legacy output leases, card submission, host responses, reset/restart, and disposal behind the scoped public facade. See [#113](https://github.com/lg061870/InsuranceSemanticV2/issues/113).
